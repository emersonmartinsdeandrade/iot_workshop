...
#define WIFI_NAME "Utkarsh"
#define WIFI_PASSWORD "utkarsh02"
#define mobile "9140542802"
#define port 80
#define server "api.thingspeak.com"
#define apiKey "1KTF1D9CV71ZECKW"
...
void prepareData()
{
      data = "";
      data += "{";
      data += "\"field1\":\""+String(74)+"\",";       // Temperature 
      data += "\"field2\":\""+String(300)+"\",";        // Light
      data += "\"field3\":\""+String(20)+"\",";         // Humidity   
      data += "\"field4\":\""+String(0)+"\",";          // Door Status ( OPEN=1 or CLOSE=0)
      data += "\"field5\":\""+String(1)+"\",";          // Power Status ( ON=1 or OFF=0 )
